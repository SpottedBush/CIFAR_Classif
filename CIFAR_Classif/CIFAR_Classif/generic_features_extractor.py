    ...
    def extract_features(self, X, dim_reduction=False, features_selection=False, threshold=0.1, n_components=2):
        ...
        if self.str_kernel == "hog":
            for img in X:
                ...
                fd = hog(rgb2gray(img), orientations=8, pixels_per_cell=(16, 16), cells_per_block=(1, 1))
        ...
        if dim_reduction:
            pca = PCA(n_components=n_components)  # Specify the number of components you want to keep
